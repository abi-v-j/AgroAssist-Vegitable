<?php
		...
		if(isset($_POST['btn_register']))
		{
			...
			$insQry="insert into tbl_farmer
			(farmer_name,farmer_contact,farmer_email,
			farmer_address,place_id,farmer_photo,farmer_proof,farmer_password,farmer_squestion,farmer_answer) values('$name','$contact','$email','$address','$place','$photo','$proof','$password','$question',$answer')";
			if($Con -> query($insQry));
			{
?>
			<script>
...
<!-- <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="200" border="1">
    <tr>
      ...
      <input type="text" name="txt_name" id="txt_name" requiredplaceholder="Enter your Name" title="Name Allows Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$" /></td>
    </tr>
    <tr>
      <td>Contact</td>
      <td><label for="txt_contact"></label>
      <input type="text" name="txt_contact" id="txt_contact" requiredplaceholder="Enter your Phonenumber" pattern="[7-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaing 9 digit with 0-9"/></td>
    </tr>
    <tr>
      <td>Email</td>
      <td><label for="txt_email"></label>
      <input type="email" name="txt_email" id="txt_email" required placeholder="Enter your Email" pattern="/^[a-zA-Z0-9.!#$%&*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/"/></td>
    </tr>
    <tr>
      <td>Address</td>
      <td><label for="txt_address"></label>
      <textarea name="txt_address" id="txt_address"cols="45" rows="5" requiredplaceholder="Enter your Address"></textarea></td>
    </tr>
    <tr>
      <td>District</td>
    ...
    <tr>
      ...
      <input type="password" name="txt_password" id="txt_password" required placeholder="Enter your Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"   /></td>
    </tr>
	 <tr>
