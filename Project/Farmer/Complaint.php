...
if (isset($_POST['btn_send'])) {
    ...
    $insQry = "INSERT INTO tbl_complaint (complaint_title, complaint_content, farmer_id, complaint_date) 
               VALUES ('$title', '$description', '" . $_SESSION['fid'] . "', CURDATE())";
...
<div class="container my-5">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <?php
            $i = 0;
            $selQry = "SELECT * FROM tbl_complaint WHERE farmer_id='" . $_SESSION['fid'] . "'";
